set SONNYLABS_API_TOKEN=your-sonnylabs-api-token-here
set SONNYLABS_ANALYSIS_ID=your-analysis-id
set SONNYLABS_BASE_URL=https://sonnylabs-service.onrender.com
